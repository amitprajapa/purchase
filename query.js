...
var url = localStorage.getItem("url") + 'buildQuery';
...
function Query() {
    ...
    this.url = localStorage.getItem("url") + 'buildQuery';
    ...
    this.setBaseQuery = function (pBaseQuery) {
        this.baseQuery = pBaseQuery;
    };
...
//Get data from ajax. 
            ...
            lAjax.setType("post");
            lAjax.setUrl(url + '?baseQuery='+this.getBaseQuery()+'&criteria=' + this.getCriteria() + '&searchCriteria=' + JSON.stringify(this.getSearchCriteria()));
...
//build column definitions
        ...
        for (var i in lCols) {
            ...
            if ($("#datatable-drpdwm-Filter")) {
//                lCols[i].DBColumn;
                $("#datatable-drpdwm-Filter").append('<option value =' + lCols[i].DBColumn + '>' + lCols[i].DBColumn + '</option>');
            }
            defs.push(def);
        }
